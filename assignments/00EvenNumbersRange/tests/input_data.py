...
input_values = [
    ...
    (
        ["4", "8"],
        ["Enter lower limit: ", "Enter upper limit: ", "Even numbers in the range: 3"],
        "The result should be 3: (4, 6 and 8 are the even numbers) \n"
    ),
    (
        ["3", "12"],
        ["Enter lower limit: ", "Enter upper limit: ", "Even numbers in the range: 5"],
        "The result should be 5: (4, 6, 8, 10 and 12 are the even numbers) \n"
    ),
    (
        ["7", "2"],
        ["Enter lower limit: ", "Enter upper limit: ", "Even numbers in the range: 0"],
        "There is no range that can go from 7 to 2 with incrementing numbers\n"
    ),
    (
        ["0", "7"],
        ["Enter lower limit: ", "Enter upper limit: ", "Even numbers in the range: 4"],
